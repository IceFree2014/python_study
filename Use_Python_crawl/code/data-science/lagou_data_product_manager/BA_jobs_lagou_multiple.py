...
#urlpage = 'https://www.lagou.com/zhaopin/shangyeshjufenxi/'

#filename = 'DA_20190805.csv'
#urlpage = 'https://www.lagou.com/zhaopin/shujufenxishi/'
...
def getJobsInfo(urlpage, filename):
	...
	area       = isEmptyListText(new_driver.find_elements_by_xpath("//*[@class='job_request']/h3/span[2]"))
	work_times = isEmptyListText(new_driver.find_elements_by_xpath("//*[@class='job_request']/h3/span[3]"))
	education  = isEmptyListText(new_driver.find_elements_by_xpath("//*[@class='job_request']/h3/span[4]"))
	work_full_time  = isEmptyListText(new_driver.find_elements_by_xpath("//*[@class='job_request']/h3/span[5]"))
...
def GetMultiplePageJobsInfo(threadName, urlpage, page_number_start, page_number_end, filename):
...
#filename = 'NLP_20190806.csv'
#urlpage = 'https://www.lagou.com/zhaopin/ziranyuyanchuli/'
filename = 'product_manager_20190814.csv'
urlpage  = 'https://www.lagou.com/zhaopin/chanpinjingli1/'
...
try:
	for i in range(1, 7):
		...
		_thread.start_new_thread(GetMultiplePageJobsInfo, ("Thread-"+string, urlpage, page_number_start, page_number_end, string + '_' +filename))
		page_number_start = page_number_start + 5
except:
